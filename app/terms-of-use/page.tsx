  ...
  return (
    <div>
      <section className="min-h-70 md:min-h-90 bg-reddamask pt-43 px-3 md:px-14">
        <h1 className="font-rubik font-bold text-4xl md:text-6xl">TERMS OF USE</h1>
        <p className="mt-3 md:mt-5 text-gray-600">Last updated: November 2025</p>
      </section>
      <Image
        ...
        height={200}
        alt="brush seperator"
        className="mb-10 w-screen -mt-10 h-20 md:h-fit"
      />
      <div className="mx-3 md:mx-14 text-sm mb-15">
        ...
        <h3 className="font-bold font-rubik mb-1 mt-3 text-base">1. Acceptance of Terms</h3>
        <p>
        ...
        <h3 className="font-bold font-rubik mb-1 mt-3 text-base">2. Description of Service</h3>
        ...
        <h3 className="font-bold font-rubik mb-1 mt-3 text-base">3. User Accounts</h3>
        <p>
        ...
        <h3 className="font-bold font-rubik mb-1 mt-3 text-base">4. Orders and Payments</h3>
        <ul className="list-disc ms-8">
        ...
        <h3 className="font-bold font-rubik mb-1 mt-3 text-base">5. Vendor Obligations</h3>
        ...
        <h3 className="font-bold font-rubik mb-1 mt-3 text-base">6. Rider Obligations</h3>
        <p>Riders must:</p>
        <ul className="list-disc ms-8">
        ...
        <h3 className="font-bold font-rubik mb-1 mt-3 text-base">7. Customer Responsibilities</h3>
        ...
        <h3 className="font-bold font-rubik mb-1 mt-3 text-base">8. Cancellations and Refunds</h3>
        ...
        <h3 className="font-bold font-rubik mb-1 mt-3 text-base">9. Intellectual Property</h3>
        <p>
        ...
        <h3 className="font-bold font-rubik mb-1 mt-3 text-base">10. Limitation of Liability</h3>
        ...
        <h3 className="font-bold font-rubik mb-1 mt-3 text-base">11. Termination</h3>
        <p>
        ...
        <h3 className="font-bold font-rubik mb-1 mt-3 text-base">12. Changes to Terms</h3>
        ...
        <h3 className="font-bold font-rubik mb-1 mt-3 text-base">13. Governing Law</h3>
        <p>
