...
export default function HeroSection() {
  return (
    <section className="relative overflow-hidden py-16 md:py-24 md:pb-9 mt-25 md:mt-10 mx-5 md:mx-0 ">
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center relative z-10 mx-5 md:mx-14">
        {/* Left: Text and Input */}
        <div className="md:text-left">
          <h1 className="text-[3.3rem]/18 md:text-7xl font-bold text-gray-900 font-rubik mb-6">
          ...
          <div className="flex md:gap-4 md:max-w-lg mx-auto md:mx-0 w-full">
            ...
            />
            <button className="bg-green-800 hover:bg-green-700 h-16 -ms-5 -mt-1 md:mt-0 md:ms-0 md:h-12 rounded-2xl text-white md:rounded-lg px-4 md:w-fit">
